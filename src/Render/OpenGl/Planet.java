...
import static Render.OpenGl.DemoUtils.*;
...
public class Planet {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int vshader = createShader("shaders/planet.vs", GL_VERTEX_SHADER);
        int fshader = createShader("shaders/planet.fs", GL_FRAGMENT_SHADER);
